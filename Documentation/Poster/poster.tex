...
%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \begin{block}{Introduction}
          Algorithmic trading is characterised by an entirely hands off approach to stock trading. Using this technique, can the average interest rate of high street banks, standing at 1.23\%, be beaten? Two possibilities will be tested, statistical methodology and a machine learning based approach. 
        \end{block}
